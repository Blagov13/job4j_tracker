...
public class Emulator {
    ...
    private static final String DIRECTORY = "Указать кэшируемую директорию";
    private static final String NOT_FILE = "Файл не найден в кеше";
    private static final String FILE = "Введите имя файла для загрузки в кеш:";
    private static final String CONTENT = "Cодержимое файла из кэша:";
